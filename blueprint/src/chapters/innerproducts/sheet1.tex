...
\begin{theorem}
  ...
  % Note: This is a simple consequence of inner_zero_right, not a separate theorem in the game
  % Not marked with \leanok as it's not a separate theorem in the Lean code
